...
from vitroflow.detectors.ultralytics.detector import ultralytics_runtime_descriptor
from vitroflow.detectors.ultralytics.runtime import ultralytics_installed
