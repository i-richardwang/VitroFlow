...
export function WorkbenchTopBar({
  ...
  return (
    <div className="grid h-12 shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-3 border-b border-separator bg-surface px-6">
      <div className="flex min-w-0 items-center gap-3">
        <Breadcrumbs className="font-mono">
          <Breadcrumbs.Item href={`/runs/${runId}`}>{runId}</Breadcrumbs.Item>
          <Breadcrumbs.Item>{stem}</Breadcrumbs.Item>
        </Breadcrumbs>
